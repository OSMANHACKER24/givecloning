...
def OSMAN_bd():
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        OSMAN_OSMAN('\033[1;97m====================================================')
        OSMAN_OSMAN(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        OSMAN_OSMAN(f'{x}[{xr}^{x}]\033[0;92m PLEASE WATE YOUR CLONING PROCESS HAS BEEN STARTED')
...
def reg():
    ...
    r = requests.get('https://github.com/OSMANHACKER24/givecloning/blob/main/givecloning.txt').text
    if to in r:
        os.system('clear')
